...
public class Trig
{
	...
	public static double Asin(double x)
	{
		if (x < -1 || x > 1)
		{
			throw new IllegalArgumentException("Input to arcsine function must be between -1 and 1");
		}
	...
	public static double Acos(double x)
	{
		if (x < -1 || x > 1)
		{
			throw new IllegalArgumentException("Input to arccosine function must be between -1 and 1");
		}
