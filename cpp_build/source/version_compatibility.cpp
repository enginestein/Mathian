...
public:
    ...
    {
        CodePorting::Translator::Cs2Cpp::VersionInfo asposecpplib_version_info;
        CodePorting::Translator::Cs2Cpp::_getVersionInfo(asposecpplib_version_info);

        CodePorting::Translator::Cs2Cpp::VersionInfo product_version_info = { 0 };
        ...
        if (asposecpplib_version_info != product_version_info)
        {
            ...
            CodePorting::Translator::Cs2Cpp::MismatchedVersionInfo mvi;
            GetModuleName(mvi.module_name);
            mvi.product_version_info = product_version_info;

            CodePorting::Translator::Cs2Cpp::_registerVersionMismatch(mvi);
#endif
  ...
  // NOOP
    ...
    static void PrintErrorMessage(std::ostream& destination, const CodePorting::Translator::Cs2Cpp::VersionInfo& product_version_info, const CodePorting::Translator::Cs2Cpp::VersionInfo& asposecpplib_version_info)
    {
        char encoded_product_version_info[CodePorting::Translator::Cs2Cpp::VersionInfo::ENCODED_VERSION_INFO_SIZE];
        product_version_info.encode(encoded_product_version_info);

        char encoded_asposecpplib_version_info[CodePorting::Translator::Cs2Cpp::VersionInfo::ENCODED_VERSION_INFO_SIZE];
        ...
        destination
            ...
            << "CodePortingTranslatorCs2CppVersionInfo: " << static_cast<const char*>(encoded_asposecpplib_version_info) << std::endl;
    }

    static void FillExpectedVersionInformation(CodePorting::Translator::Cs2Cpp::VersionInfo& product_version_info)
    {
